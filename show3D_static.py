...
if __name__ == "__main__":
    ...
    for ind in [0,1,2,3]:
        vtk_all(pathResults / Path('result_' + str(ind) + '.vtu'), dataIn[ind,:,:,:,3], dataIn[ind,:,:,:,4],dataIn[ind,:,:,:,5],dataIn[ind,:,:,:,6], dataIn[ind,:,:,:,0], dataIn[ind,:,:,:,1], dataIn[ind,:,:,:,2], gen[ind,:,:,:,0], gen[ind,:,:,:,1], gen[ind,:,:,:,2], gen[ind,:,:,:,3])
        vtk(pathResults / Path('result_spec_'+ str(ind) + '.vtu'), dataIn[ind, :, :, :, 3], dataIn[ind, :, :, :, 0], dataIn[ind, :, :, :, 1],
            dataIn[ind, :, :, :, 2], dataOut[ind, :, :, :, 0], dataOut[ind, :, :, :, 1], dataOut[ind, :, :, :, 2], dataOut[ind, :, :, :, 3])
