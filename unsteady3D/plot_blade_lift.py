...
if __name__ == '__main__':
    ...
    # pathResults = projectDir / 'data' / 'test_coarse_unet_on_fine_mesh' / 'results_blade_pressure_vent10ooo'
    pathResults = projectDir / 'data' / 'net7_3D_multistep_lowo_v4' / 'results_blade_pressure_vent10'
