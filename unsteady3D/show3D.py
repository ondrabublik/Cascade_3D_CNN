...
def prepareDataInFromCFD(ind, matFiles, B, dt):
    ...
    dataIn[0:1,0:nx, 0:ny, 0:nz, 8] = mat['parameters'][0][0][0][0] / 20
...
if __name__ == "__main__":
    dataDirs = ['../../reader3D/SimpleBladeExtrapolation/unsteady_interpolation/transformed/v10']
    path = Path('../../data/net24_3D')
