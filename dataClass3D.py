...
class Data:
	def __init__(self, dirs):
		...
		self.nSamplesTot = 0
		self.nx = 128 # TODO make programmatically
		self.ny = 128
		self.nz = 448
		self.parameters = {}
		self.scales = {}
	...
	def setParameters(self):
		self.parameters = {'Re': 5000, 'dt': 0.25}
	...
	def setData(self, mat, nextMat, dataIn, dataOut, B):
		...
		dataIn[0:nx, 0:ny, 0:nz, 7] = mat['u'][0][0] + u_noise
		dataIn[0:nx, 0:ny, 0:nz, 8] = mat['v'][0][0] + v_noise
		dataIn[0:nx, 0:ny, 0:nz, 9] = mat['w'][0][0] + w_noise
		dataIn[0:nx, 0:ny, 0:nz, 10] = mat['p'][0][0] + p_noise
	...
	def prepare_training_data(self):
		...
		md = meshDeformation3D(self.parentDir / Path('def3D.mat'))
		B = md.computeB()
